...
if TYPE_CHECKING:
    from swarmline.observability.activity_types import ActivityEntry, ActivityFilter
...
class SqliteActivityLog:
    ...
    def _log_sync(self, entry: ActivityEntry) -> None:
        from swarmline.observability.activity_types import ActorType  # noqa: F811
    ...
    def _query_sync(self, filter: ActivityFilter) -> list[ActivityEntry]:
        from swarmline.observability.activity_types import ActivityEntry as AE
        from swarmline.observability.activity_types import ActorType
