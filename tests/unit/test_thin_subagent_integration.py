...
class TestThinRuntimeSubagentWiring:
    ...
    def test_without_subagent_config_no_spawn_tool(
        self, thin_config: RuntimeConfig
    ) -> None:
    ...
    def test_with_subagent_config_has_spawn_tool(
        self, thin_config: RuntimeConfig
    ) -> None:
    ...
    def test_subagent_tool_spec_in_builtin_specs(
        self, thin_config: RuntimeConfig
    ) -> None:
    ...
    def test_no_subagent_config_no_spec_stored(
        self, thin_config: RuntimeConfig
    ) -> None:
