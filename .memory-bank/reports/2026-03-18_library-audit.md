...
Полный read-only аудит библиотеки `swarmline` по следующим направлениям:
...
- `mypy src/swarmline/`: `48 errors in 23 files`
...
- `src/swarmline/agent/agent.py:169-174`
- `src/swarmline/agent/conversation.py:145-149`

При этом сами runtime'ы умеют принимать remote MCP servers:

- `src/swarmline/runtime/deepagents.py:70-86`
- `src/swarmline/runtime/thin/runtime.py:53-58`
...
- `src/swarmline/runtime/base.py:3-8`
- `src/swarmline/runtime/base.py:62-65`

Но фасадный сбор результата и conversation-history это игнорируют:

- `src/swarmline/agent/agent.py:297-333`
- `src/swarmline/agent/conversation.py:54-63`
- `src/swarmline/agent/conversation.py:86-95`

Это уже ломает реальный сценарий в `ThinRuntime` react path, где tool-call context складывается в `new_messages`:

- `src/swarmline/runtime/thin/react_strategy.py:190-206`
...
- `src/swarmline/orchestration/thin_team.py:72-90`

Но `ThinSubagentRuntime` публикует только `self._spec.tools`:

- `src/swarmline/orchestration/thin_subagent.py:194-207`
...
- `src/swarmline/orchestration/runtime_helpers.py:14-49`
...
- `src/swarmline/runtime/ports/thin.py:73-85`
...
- `src/swarmline/runtime/sdk_query.py:160-170`
- `src/swarmline/runtime/sdk_query.py:221-267`
- `src/swarmline/runtime/adapter.py:291-342`
...
- `src/swarmline/runtime/ports/base.py:269-294`

Аналогично `SessionManager.stream_reply()` для runtime path:

- `src/swarmline/session/manager.py:287-335`
...
- `src/swarmline/session/types.py:27-41`
- `src/swarmline/session/manager.py:270-340`
...
- `src/swarmline/agent/agent.py:105-213`
- `src/swarmline/agent/conversation.py:114-220`
...
- `src/swarmline/agent/agent.py:136-156`
- `src/swarmline/agent/conversation.py:192-210`
...
- `src/swarmline/runtime/factory.py:152-192`
...
- `src/swarmline/runtime/factory.py:152-171`
...
В `swarmline.runtime` optional symbols сначала присваиваются `None`, а затем попадают в `__all__` независимо от наличия extras:

- `src/swarmline/runtime/__init__.py:42-48`
- `src/swarmline/runtime/__init__.py:66-84`
- `src/swarmline/runtime/__init__.py:86-129`

Схожий паттерн есть в:

- `src/swarmline/runtime/ports/__init__.py:17-24`
- `src/swarmline/hooks/__init__.py:7-10`
...
- `src/swarmline/runtime/thin/runtime.py:63-70`

А buffered strategies затем ещё раз передают `retry_policy` в `run_buffered_llm_call()`:

- `src/swarmline/runtime/thin/helpers.py:44-50`
- `src/swarmline/runtime/thin/conversational.py:43-56`
- `src/swarmline/runtime/thin/react_strategy.py:65-73`
...
- `src/swarmline/agent/agent.py:21-24`
- `src/swarmline/agent/agent.py:79-84`
- `src/swarmline/agent/agent.py:169-191`
...
Докстринг обещает зависимости только на `swarmline.types` и stdlib:

- `src/swarmline/protocols/__init__.py:1-8`

Но протоколы импортируют конкретные типы из инфраструктурных/смежных пакетов:

- `src/swarmline/protocols/memory.py:7`
- `src/swarmline/protocols/runtime.py:28-31`
...
- `src/swarmline/runtime/deepagents.py:11` — `E402`
- `src/swarmline/runtime/__init__.py:50` — `E402`
- `src/swarmline/memory/__init__.py:23` — `F401`
...
- `src/swarmline/runtime/structured_output.py:11-30`
- `src/swarmline/runtime/sdk_query.py:55-88`
- `src/swarmline/runtime/options_builder.py:123-149`
- `src/swarmline/memory/sqlite.py:127`, `164`, `201`, `246`
- `src/swarmline/runtime/adapter.py:36`

### `dev` extra is insufficient for advertised type-check workflow

`pyproject.toml` рекламирует `mypy src/swarmline/`, но `dev` extra не включает ни optional extras, ни stub packages:
...
- `src/swarmline/memory/__init__.py:22-35` — `PostgresMemoryProvider` импортируется, но не экспортируется
- `src/swarmline/skills/__init__.py:13-20` — `YamlSkillLoader` и `load_mcp_from_settings` импортируются, но не экспортируются
